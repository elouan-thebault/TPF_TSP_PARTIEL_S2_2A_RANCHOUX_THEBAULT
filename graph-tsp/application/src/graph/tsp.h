...
/// @return La tournée.
Path* Graph_tspFromHeuristic(Graph* distances, int station);
...
Path* Graph_acoConstructPath(Graph* distances, Graph* pheromones, int station, float alpha, float beta);
