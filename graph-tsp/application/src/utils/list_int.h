...
/// @param self la liste utilisée comme une file.
/// @param value l'entier.
INLINE void ListInt_enqueue(ListInt* self, int value)
{
    assert(self && "self must not be NULL");
    ListInt_insertLast(self, value);
}

/// @brief Défile un entier dans une file.
/// @param self la liste utilisée comme une file.
/// @param value l'entier.
INLINE int ListInt_dequeue(ListInt* self)
{
    assert(self && "self must not be NULL");
    return ListInt_popFirst(self);
}

/// @brief Empile un entier dans une pile.
/// @param self la liste utilisée comme une pile.
/// @param value l'entier.
INLINE void ListInt_push(ListInt* self, int value)
{
    assert(self && "self must not be NULL");
    ListInt_insertLast(self, value);
}
...
/// @param self la liste utilisée comme une pile.
/// @param value l'entier.
INLINE int ListInt_pop(ListInt* self)
{
    assert(self && "self must not be NULL");
    return ListInt_popLast(self);
}
